@echo off
REM ===========================================================================
REM  Put the Minecraft bridge mod where the game will find it
REM
REM  Exists because `py tools\install_mod.py` only works from the project
...
setlocal
cd /d "%~dp0"
title Put the Minecraft bridge mod where the game will find it
