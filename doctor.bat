@echo off
REM ===========================================================================
REM  Check that MARK LIV is set up correctly
REM
REM  Exists because `py tools\doctor.py` only works from the project
...
setlocal
cd /d "%~dp0"
title Check that MARK LIV is set up correctly
